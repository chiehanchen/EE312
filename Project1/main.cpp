...
void simpleTest2(void) {
    ...
    char superstrings[] = "\n\n\n\n\n\n             \n          we"; //a ab ab
    char strings[] = "Hello we are writing this without any punctuation to fit the requirements of the project\n"
                     "Intellectualization apart i think this has some benefit";
